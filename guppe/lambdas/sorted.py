...
usuarios = [
    {"usuário": "lucas", "tweets": ["Eu adoro bolos", "Eu adoro pizzas"],"tema": ["TESTE"]},
...
print(sorted(usuarios, key=len, reverse=False))
print("-------")
# Pelo campo usuario
print(sorted(usuarios, key=lambda usuario: usuario["usuário"]))
print("-------")
# Pela quantidade de tweets
...
print("-------")
# Pela quantidade de repeticoes crescente
print(sorted(musicas, key=lambda musica: musica["repetições"]))
print("-------")
# Pela quantidade de repeticoes decrescente
